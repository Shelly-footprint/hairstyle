...
const TRANSLATIONS = {
  en: {
    ...
    authDesc: "Use your own Google API key for unlimited generation.",
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans">
      ...
      {!hasApiKey && (
        <div className="fixed inset-0 z-[60] bg-slate-900/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 text-center">
            ...
            >
              <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="Google" className="h-5 bg-white rounded px-1" />
              {t.connectAccount}
            </button>
            <a 
              ...
              className="block mt-4 text-xs text-indigo-500 hover:underline"
            >
              {t.billingInfo}
            </a>
          </div>
      ...
      {/* Main Content */}
      <main className={`flex-grow flex flex-col md:flex-row h-[calc(100vh-3.5rem)] overflow-hidden ${!hasApiKey ? 'blur-sm pointer-events-none' : ''}`}>
              ...
              <div className="grid grid-cols-3 gap-1 mb-4 p-1 bg-slate-100 rounded-xl">
                 <button
                   ...
                   className={`flex flex-col items-center justify-center py-2 px-1 rounded-lg text-[10px] font-medium transition-all ${
                     activeTab === 'reference' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'
                   }`}
                 >
                 ...
                 <button
                   ...
                   className={`flex flex-col items-center justify-center py-2 px-1 rounded-lg text-[10px] font-medium transition-all ${
                     activeTab === 'lucky' ? 'bg-white text-orange-500 shadow-sm' : 'text-slate-500 hover:text-slate-800'
                   }`}
                 >
